          ...
          <Form>
            <Form.Field>
              {this.state.permission !== 'default' ?
                <p>You can change the notification settings in your browser preferences.</p> : ''}
              <Button disabled={this.state.permission !== 'default'}
                      color={'blue'}
                      onClick={this.requestPermission}>Request Permission</Button>
              <Button disabled={this.state.permission !== 'granted'}
                      onClick={this.testNotification}>Test Notifications</Button>
            </Form.Field>
          </Form>
        </ErrorBoundary>
      </div>
